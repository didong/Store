...
/**
 * Created by di_dong on 2017/5/24.
 */
public class VerificationCodeUtil {

     public static Map<String,String> getVerificationCode() throws IOException {
         int base = 50;
         int height = base;
         int width = base * 4;
        ...
        // session.setAttribute("valistr", buffer.toString());
       ...
       //  File file = new File("D:/di_dong.gif");
         ImageIO.write(img,"gif",bao);
      /*   FileInputStream fileInputStream = new FileInputStream("D:/di_dong.gif");
         ...
         map.put(buffer.toString(),base64Encoder.encode(b));
          return map;
    }

    private static int getRand(int begin,int end){
